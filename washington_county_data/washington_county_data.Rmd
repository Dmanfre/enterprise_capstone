...
h_2021 <- get_acs(geography = "place",
              variables = c(medi_house_income = "B19013_001", population = "B01003_001", medi_home_value = "B25077_001"),
              state = "MD",
              year = 2021) %>% 
...
variables = c(medi_house_income = "B19013_001", population = "B01003_001", medi_home_value = "B25077_001"),              state = "MD",
              year = 2021) %>% 
...
#Combine all 2021 income
#all_pop_2021 <-  bind_rows(a_pop_2021, ba_pop_2021, bo_pop_2021, f_pop_2021, h_pop_2021, s_pop_2021, w_pop_2021) %>% clean_names() %>% select(variable, year, name, estimate)
...
```{r}
## USING THIS SECTION TO GET MEDIAN HOUSING VALUES
